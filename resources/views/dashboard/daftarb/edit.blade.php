...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <h5 class="card-header text-center">EDIT DAFTAR KELAS B</h5>
            <div class="card-body">
                <form class="needs-validation" action ="/daftarbdashboard/{{$daftarbs->id}}" method="post">
                   @method('PATCH')
                   @csrf
                   <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                        <label for="validationCustom01">Hari</label>
                        <input type="text" class="form-control  @error('hari') is-invalid @enderror" value="{{old('hari',$daftarbs->hari)}}" name="hari" required >
                        @error('hari')
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                        ...
                        <input type="text" class="form-control  @error('jam') is-invalid @enderror" value="{{old('jam',$daftarbs->jam)}}" name="jam" required>
                        @error('jam')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                        ...
                        <div >
                            <select class="form-control" aria-label="Default select example" name="matkul_id"><br><br>
                                ...
                                @if (old('matkul_id',$daftarbs->matkul_id)== $matkul->id)
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                        ...
                        <div >
                            <select class="form-control" aria-label="Default select example" name="dosen_id"><br><br>
                                ...
                                @if (old('dosen_id',$daftarbs->dosen_id)== $dosen->id)
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-4 ">
                        ...
                        <a href="/daftarbdashboard" class="btn btn-primary btn-sm"><i class=" fas fa-reply"> Back</i></a>
                    </div>
                </div>
                </div>
            </form>
