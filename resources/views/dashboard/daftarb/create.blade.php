...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <h5 class="card-header text-center">FORM DAFTAR KELAS B</h5>
            <div class="card-body">
                <form class="needs-validation" action ="/daftarbdashboard" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            <label for="validationCustom01">Hari</label>
                            <input type="text" class="form-control  @error('hari') is-invalid @enderror" value="{{old('hari')}}" name="hari" required>
                            @error('hari')
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            ...
                            <input type="text" class="form-control  @error('jam') is-invalid @enderror" value="{{old('jam')}}" name="jam" required>
                            @error('jam')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
